        ...
        <div className="flex flex-col items-start justify-between gap-3 ml-0 shrink-0 h-full">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2 text-xs">
              <div className="flex items-center gap-1">
                <span className="text-muted-foreground">{t("feed:criteries.gameplay")}:</span>
                <div className="flex">
                  {[...Array(5)].map((_, index) => {
              ...
              <p>•</p>
              <div className="flex items-center gap-1">
                <span className="text-muted-foreground">{t("feed:criteries.story")}:</span>
                <div className="flex">
                  {[...Array(5)].map((_, index) => {
              ...
              <p>•</p>
              <div className="flex items-center gap-1">
                <span className="text-muted-foreground">{t("feed:criteries.graphics")}:</span>
                <div className="flex">
                  {[...Array(5)].map((_, index) => {
              ...
              <p>•</p>
              <div className="flex items-center gap-1">
                <span className="text-muted-foreground">{t("feed:criteries.soundtrack")}:</span>
                <div className="flex">
                  {[...Array(5)].map((_, index) => {
