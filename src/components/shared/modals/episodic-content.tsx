            ...
            <div className="space-y-3">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="watching">{t("feed:lists.watching")}</SelectItem>
                      <SelectItem value="completed">{t("feed:lists.completed")}</SelectItem>
                      <SelectItem value="rewatching">{t("feed:lists.rewatching")}</SelectItem>
              ...
              <Field>
                ...
                <InputGroup className="bg-background">
                  <InputGroupInput id="episodes" type="number" min={0} placeholder="0" />
