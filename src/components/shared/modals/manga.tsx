            ...
            <div className="space-y-3">
              <Field>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectItem value="toRead">{t("feed:lists.toRead")}</SelectItem>
                      <SelectItem value="reading">{t("feed:lists.reading")}</SelectItem>
                      <SelectItem value="completed">{t("feed:lists.completed")}</SelectItem>
                      <SelectItem value="rereading">{t("feed:lists.rereading")}</SelectItem>
              ...
              <Field>
                ...
                <InputGroup className="bg-background">
                  <InputGroupInput id="chapters" type="number" min={0} placeholder="0" />
                  <InputGroupAddon align="inline-end">
                    <InputGroupText>/125</InputGroupText>
                  </InputGroupAddon>
                </InputGroup>
              </Field>

              <Field>
                <FieldLabel htmlFor="volumes" className="text-sm font-medium">
                  {t("library:volumes")}
                </FieldLabel>
                <InputGroup className="bg-background">
                  <InputGroupInput id="volumes" type="number" min={0} placeholder="0" />
                  <InputGroupAddon align="inline-end">
              ...
              <Field>
                ...
                <Input id="rereads" type="number" min={0} placeholder="0" className="bg-background" />
              </Field>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-muted/30 rounded-lg p-4 border border-border/50">
            ...
            <div className="space-y-2">
              {["2026", "Favorites", "Read Later"].map((list) => (
