                ...
                <AccordionContent className="mt-3">
                  <ul className="list-disc list-inside space-y-2">
                    <Trans
                      ...
                      i18nKey="pages:addData.createAccount"
                      components={{
                        1: <a href="https://www.themoviedb.org/signup" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                    <Trans
                      parent="li"
                      i18nKey="pages:addData.fillInfo"
                      components={{
                        1: <a href="https://www.themoviedb.org/movie/new" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                ...
                <AccordionContent className="mt-3">
                  <ul className="list-disc list-inside space-y-2">
                    <Trans
                      ...
                      i18nKey="pages:addData.createAccount"
                      components={{
                        1: <a href="https://www.igdb.com/oauth/twitch" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                    <Trans
                      parent="li"
                      i18nKey="pages:addData.fillInfo"
                      components={{
                        1: <a href="https://www.igdb.com/games/new" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                ...
                <AccordionContent className="mt-3">
                  <ul className="list-disc list-inside space-y-2">
                    <Trans
                      ...
                      i18nKey="pages:addData.createAccount"
                      components={{
                        1: <a href="https://hardcover.app/" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                    <Trans
                      parent="li"
                      i18nKey="pages:addData.fillInfo"
                      components={{
                        1: <a href="https://hardcover.app/books/new" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                    <li>{t("pages:addData.save")}</li>
                  </ul>
                ...
                <AccordionContent className="mt-3">
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <Trans
                      ...
                      i18nKey="pages:addData.fillInfo"
                      components={{
                        1: <a href="https://www.themoviedb.org/tv/new" rel="noopener noreferrer" target="_blank" />,
                      }}
                    />
                    <li>{t("pages:addData.save")}</li>
                  </ul>
