...
function DonateRoute() {
  ...
  const finalAmount = amountType === "fixed" ? selectedAmount : parseFloat(customAmount) || 0;
        ...
        <div className="p-10 sm:px-56 bg-linear-to-br from-muted/50 to-muted my-10 rounded-lg text-white flex flex-col items-center gap-y-3 text-center">
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-6 gap-6 flex flex-col bg-card text-card-foreground">
              ...
              <div>
                <label className="text-sm font-semibold mb-3 block">{t("pages:donate.modal.type")}</label>
              ...
              <div>
                <label className="text-sm font-semibold mb-3 block">{t("pages:donate.modal.select")}</label>
              ...
              <div>
                <label className="text-sm font-semibold mb-3 block">{t("pages:donate.modal.method")}</label>
        ...
        <div className="my-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              {
                title: "10$",
                benefits: [t("pages:donate.perks.benefit5"), t("pages:donate.perks.benefit6")],
              },
            ].map((item) => {
              return (
                <div
                ...
                >
                  <h3 className="text-lg font-semibold mb-4 text-white text-center">{item.title}</h3>
