    ...
    <div className="flex flex-col gap-8">
      <div className="bg-card rounded-2xl shadow-lg p-8 text-muted-foreground">
        ...
        <div className="space-y-6 leading-relaxed">
          ...
          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.dataWeCollect.title")}</h2>
          ...
          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.howWeUseData.title")}</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.thirdParties.title")}</h2>
            <p>{t("pages:privacyPolicy.thirdParties.metadata")}</p>
            <p className="mt-2">{t("pages:privacyPolicy.thirdParties.analytics")}</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.payments.title")}</h2>
            <p>{t("pages:privacyPolicy.payments.info")}</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.dataRetention.title")}</h2>
            <p>{t("pages:privacyPolicy.dataRetention.text")}</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.userRights.title")}</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.security.title")}</h2>
            <p>{t("pages:privacyPolicy.security.text")}</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.children.title")}</h2>
            <p>{t("pages:privacyPolicy.children.text")}</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg mb-2 text-primary">{t("pages:privacyPolicy.changes.title")}</h2>
