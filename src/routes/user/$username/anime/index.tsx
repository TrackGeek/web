...
export const Route = createFileRoute("/user/$username/anime/")({
	head: ({ params }) => ({
		meta: [{ title: `Anime List | TrackGeek` }],
	}),
	loader: async () => {
				...
				<div className="w-full md:w-1/4 flex flex-col gap-6">
					<div className="bg-card rounded-2xl shadow-lg p-6 gap-4 flex flex-col">
							...
							<SelectContent>
								<SelectGroup>
									...
									<SelectItem value={"movie"}>
										{t("common:types.movie")}
									</SelectItem>
									<SelectItem value={"ova"}>OVA</SelectItem>
									<SelectItem value={"ona"}>ONA</SelectItem>
									<SelectItem value={"special"}>
										{t("library:types.Special")}
									</SelectItem>
									<SelectItem value={"TVSpecial"}>
										{t("library:types.TVSpecial")}
									</SelectItem>
									<SelectItem value={"music"}>
										{t("library:types.Music")}
									</SelectItem>
						...
						<Select>
							...
							<SelectContent>
								<SelectGroup>
									<SelectItem value={"notYetAired"}>
										{t("library:statusAir.notYetAired")}
									</SelectItem>
									<SelectItem value={"currentlyAiring"}>
										{t("library:statusAir.currentlyAiring")}
									</SelectItem>
									<SelectItem value={"finishedAiring"}>
										{t("library:statusAir.finishedAiring")}
									</SelectItem>
								</SelectGroup>
							</SelectContent>
						</Select>
