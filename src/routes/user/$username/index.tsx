  ...
  const characters = [
    {
      id: "c1",
      name: "Spike Spiegel",
      image: "https://media.themoviedb.org/t/p/w600_and_h900_face/p8VUk0ZSzfAF9uWjWg2jEVpPtTy.jpg",
      link: "/anime/1",
    },
    {
      id: "c2",
      name: "Spike Spiegel",
      image: "https://media.themoviedb.org/t/p/w600_and_h900_face/kYRu965Jt11NWWbJ9XtSUOhTkUx.jpg",
      link: "/anime/1",
    },
    {
      id: "c3",
      ...
      <div className="flex max-sm:flex-col gap-5">
        <div className="w-full md:w-1/3 flex flex-col gap-6">
          <div className="bg-card rounded-2xl shadow-lg p-6">
            <h4 className="text-md font-semibold text-card-foreground mb-3">{t("user:bio")}</h4>
            <p className="text-muted-foreground leading-relaxed">{user.bio}</p>
          </div>

          <div className="bg-card rounded-2xl shadow-lg p-6">
            <h4 className="text-md font-semibold text-card-foreground mb-3">{t("user:medals")}</h4>
            <Grid minColSize={"40px"}>
              {medals.map((medal) => (
                <MedalIcon key={medal.id} name={medal.name} description={medal.description} />
              ))}
            </Grid>
          </div>

          <div className="bg-card rounded-2xl shadow-lg p-6">
            <h4 className="text-md font-semibold text-card-foreground mb-3">{t("user:favorites")}</h4>

            {animeFavorites.length > 0 && (
              <div className="mb-4">
                <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("common:types.anime_other")}</h5>
            ...
            {bookFavorites.length > 0 && (
              <div className="mb-4">
                <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("common:types.book_other")}</h5>
                <Grid minColSize={"24px"} className="text-sm">
            ...
            {mangaFavorites.length > 0 && (
              <div className="mb-4">
                <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("common:types.manga_other")}</h5>
                <Grid minColSize={"24px"} className="text-sm">
            ...
            {gameFavorites.length > 0 && (
              <div className="mb-4">
                <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("common:types.game_other")}</h5>
                <Grid minColSize={"24px"} className="text-sm">
            ...
            {serieFavorites.length > 0 && (
              <div className="mb-4">
                <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("common:types.tv_other")}</h5>
                <Grid minColSize={"24px"} className="text-sm">
            ...
            {movieFavorites.length > 0 && (
              <div className="mb-4">
                <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("common:types.movie_other")}</h5>
            ...
            <div className="mt-2">
              <h5 className="text-sm font-semibold text-card-foreground mb-2">{t("library:studios")}</h5>
            ...
            <div className="mt-2">
              <h5 className="text-sm font-semibold text-card-foreground">{t("library:characters")}</h5>
              <Grid minColSize={"96px"} gap={"8px"}>
                {characters.slice(0, 6).map((c) => (
                  <CastFavoriteCard name={c.name} image={c.image} link={c.link} key={c.id} />
                ))}
              </Grid>
            </div>

            <div className="mt-2">
              <h5 className="text-sm font-semibold text-card-foreground">{t("library:cast")}</h5>
              <Grid minColSize={"96px"} gap={"8px"}>
                {staff.slice(0, 6).map((s) => (
                  <CastFavoriteCard name={s.name} image={s.image} link={s.link} key={s.id} />
                ))}
              </Grid>
            </div>
          </div>
